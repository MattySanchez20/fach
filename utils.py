...
def p_by_distance(attacker: JetFighter, defender: JetFighter, d_ab):
    ...
    attacker_cannon_spread_area = (math.tan(attacker.cannon_spread_rads) * d_ab)**2 * 3.141
    defender_cannon_spread_area = (math.tan(defender.cannon_spread_rads) * d_ab)**2 * 3.141
