...
class JetFighter(ABC):
    ...
    def __init__(self, name, health, cannon_ammo, fire_rate, wingspan, damage_per_round, cannon_spread_degs):
        self.name = name
        self.health = health
...
class F16(JetFighter):
    ...
    def __init__(self):
        super().__init__(name="F16", health=100, cannon_ammo=120, fire_rate=40, wingspan=45, damage_per_round=5/100, cannon_spread_degs=4)
...
class F18(JetFighter):
    ...
    def __init__(self):
        super().__init__(name="F18", health=100, cannon_ammo=240, fire_rate=50, wingspan=50, damage_per_round=3/100, cannon_spread_degs=6)
        self.cannon_spread_rads = math.radians(self.cannon_spread_degs)
        self.cross_sectional_area = (self.wingspan/2)**2 * 3.141
